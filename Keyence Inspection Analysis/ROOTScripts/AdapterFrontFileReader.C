...
void AdapterFrontFileReader(int startSerial, int endSerial) {
    ...
    TFile outFile("newAdapterFrontTreeFile.root", "RECREATE");
    ...
    for (int i = startSerial; i <= endSerial; i++) {
        std::string filename = "/home/tkdkrishna/BoardData/AdapterFront/";
