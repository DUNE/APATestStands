...
void CRFrontFileReader(int startSerial, int endSerial) {
    ...
    TFile outFile("newCRFrontTreeFile.root", "RECREATE");
    ...
    for (int i = startSerial; i <= endSerial; i++) {
        std::string filename = "/home/tkdkrishna/BoardData/CRFront/";
