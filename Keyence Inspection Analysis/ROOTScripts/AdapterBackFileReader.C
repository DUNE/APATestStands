...
void AdapterBackFileReader(int startSerial, int endSerial) {
    ...
    TFile outFile("newAdapterBackTreeFile.root", "RECREATE");
    ...
    for (int i = startSerial; i <= endSerial; i++) {
        std::string filename = "/home/tkdkrishna/BoardData/AdapterBack/";
